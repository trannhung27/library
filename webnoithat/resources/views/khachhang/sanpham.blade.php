        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <form action="">
                    ...
                    <div class="panel">
                        <div class="panel-body">
                            <textarea class="form-control comment-content" rows="2" placeholder="What are you thinking?"></textarea>
                        </div>
                    </div>
                    <button type="button" class="btn btn-dark mr-2 mt-2 send-comment">Gửi bình luận</button>
                </form>
                ...
                <form action="">
                    ...
                    <input type="hidden" class="comment_product_id" value="{{$row->idproduct}}">
...
<script>
    $(document).ready(function(){
            ...
            //             huyen += '<div class="comment">' + value.comment + '</div>';  
            //             alert(huyen);
            //         });
                   
            //         $('.comment').html('').append(huyen);
            ...
            $.ajax({
                ...
                success: function (data) {
                    let huyen = '';
                    $.each(data.data, function(index, value){
                        huyen += '<textarea name="" id="" cols="30" rows="10">' + value.name + '</textarea>';  
                    });
                   
                    $('.thu').html('').append(huyen);
