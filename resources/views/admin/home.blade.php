...
<body class="main-layout home_page">
                        ...
                        <div class="limit-box">
                           <nav class="main-menu">
                              <ul class="menu-area-main">
                                 ...
                                 <li class="mean-last"> <a href="#search"><img src="{{asset('images/search_icon.png')}}" alt="#"/></a> </li>
                                 <li class="mean-last" > 
                                 <input type="hidden" value="{{Auth::user()->id}}" id="iduser">
                                    <a href="#">
                                        <img src="{{asset('images/top-icon.png')}}" alt="#" />
                                        <span id="#" style="font-size: 13px;" title="Đăng xuất">{{Auth::user()->name}}&ensp;<i class="fa fa-power-off" aria-hidden="true"></i></span>
               ...
               <div class="col-md-3">          
                  <div class="profile-sidebar">                          
                     ...
                     <div class="profile-usermenu"> 
                        ...
                        <div class="usermenu-item" id="info-admin"><a href="#thongtincanhan-admin"></a><i class="fas fa-user"></i></i>&ensp;Thông tin cá nhân</a></div>
                        <div class="usermenu-item" id="manage-reader"><a href="#quanlydocgia"><i class="fas fa-users"></i></i>&ensp;Quản lý độc giả</a></div>
                        <div class="usermenu-item" id="manage-doc"><a href="#quanlytailieu"><i class="fas fa-book"></i></i>&ensp;Quản lý tài liệu</a></div>
                        <div class="usermenu-item" id="manage-muon-tra"><a href="quanlymuontra"><i class="fas fa-pen"></i></i>&ensp;Quản lý mượn/trả</a></div>
      ...
      <div class="form-edit" id="form-edit-pass">
         ...
         <div class="form-box">
            ...
            <div class="edit-content">    
               Mật khẩu cũ:
               <div><input class="oldpass" type="password" placeholder=""/></div>
               Mật khẩu mới:
               <div><input class="newpass" type="password" placeholder=""/></div>
            </div>
            <div class="form-edit-footer"><<button type="submit" id="changepass">Submit</button></a></div>
         </div>
      ...
      <input type="hidden" value="{{Auth::user()->password}}" id="password">
